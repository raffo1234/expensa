...
export default function AssignedBy({ assignedBy }: { assignedBy: AssignedByType }) {
  ...
  return (
    <Popover
      ...
      content={
        <div
          className={`${isPopoverOpen ? "opacity-100 translate-y-0" : "opacity-0 translate-y-1"} w-50 py-5 px-4 transition-all duration-300 ease-in-out rounded-lg bg-white shadow-sm`}
        >
    ...
    >
      <CircularSecondaryButton
        ...
        title={isPopoverOpen ? null : title}
