    ...
    <>
      {session?.user && user ? (
        ...
        <Link
          title={t("sign-in")}
          href="/session/new"
          className="cursor-pointer flex gap-2 bg-black text-sm hover:slate-900 px-6 py-2 text-white rounded-full transition-colors duration-700 active:bg-gray-900 items-center"
        >
          <svg
