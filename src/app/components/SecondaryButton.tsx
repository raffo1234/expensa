...
const secondaryClassName =
  "flex items-center cursor-pointer active:scale-95 gap-2 px-6 py-2 bg-white border border-gray-200 rounded-full text-sm font-medium text-gray-700 hover:bg-gray-50 transition-colors duration-200";
